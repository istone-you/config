...
local _filter = function (filter)
	...
	filter = filter or require("config.markview.spec").get({ "preview", "raw_previews" }, { fallback = {}, ignore_enable = true });
...
renderer.render = function (buffer, parsed_content)
	...
	local _renderers = {
		asciidoc = require("config.markview.renderers.asciidoc"),
		asciidoc_inline = require("config.markview.renderers.asciidoc_inline"),
		comment = require("config.markview.renderers.comment"),
		html = require("config.markview.renderers.html"),
		markdown = require("config.markview.renderers.markdown"),
		markdown_inline = require("config.markview.renderers.markdown_inline"),
		latex = require("config.markview.renderers.latex"),
		yaml = require("config.markview.renderers.yaml"),
		typst = require("config.markview.renderers.typst"),
	};
