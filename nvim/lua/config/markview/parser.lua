...
local parser = {};
local health = require("config.markview.health");
...
parser.init = function (buffer, from, to, cache)
	...
	local _parsers = {
		asciidoc = require("config.markview.parsers.asciidoc"),
		asciidoc_inline = require("config.markview.parsers.asciidoc_inline"),
		comment = require("config.markview.parsers.comment");
		markdown = require("config.markview.parsers.markdown");
		markdown_inline = require("config.markview.parsers.markdown_inline");
		html = require("config.markview.parsers.html");
		latex = require("config.markview.parsers.latex");
		typst = require("config.markview.parsers.typst");
		yaml = require("config.markview.parsers.yaml");
	};
...
parser.parse_links = function (buffer)
	...
	local _parsers = {
		markdown = require("config.markview.parsers.links.markdown");
		-- markdown_inline = require("config.markview.parsers.markdown_inline");
		html = require("config.markview.parsers.links.html");
		-- latex = require("config.markview.parsers.latex");
		-- typst = require("config.markview.parsers.typst");
		-- yaml = require("config.markview.parsers.yaml");
	};
	...
	require("config.markview.links").clear(buffer);
